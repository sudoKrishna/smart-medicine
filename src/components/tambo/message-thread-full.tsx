  ...
  const defaultSuggestions: Suggestion[] = [
    {
      ...
      detailedSuggestion: "Compare Crocin with cheaper alternatives",
      messageId: "medicine-compare",
    },
    {
      id: "medicine-price",
      title: "Medicine price",
      detailedSuggestion: "Show price comparison for Paracetamol 500mg",
      messageId: "medicine-price",
    },
    {
      id: "medicine-alt",
      title: "Cheaper alternative",
      detailedSuggestion: "Find cheaper alternatives for Calpol",
      messageId: "medicine-alt",
    },
  ];
